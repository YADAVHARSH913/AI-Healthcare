    ...
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <section className="relative h-screen flex items-center justify-center text-center">
        ...
        <div className="relative z-10 text-white px-4">
          <h1 className="text-5xl md:text-7xl font-extrabold mb-4">AI Powered Healthcare</h1>
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-8">
            Aapki sehat, hamari zimmedari. AI ki madad se behtar aur tez ilaaj paayein.
          </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6 text-center">
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-3 gap-12">
                <div className="hidden md:block absolute top-1/2 left-0 w-full h-1 border-t-2 border-dashed border-gray-300" style={{transform: 'translateY(-50%)', top: '60px'}}></div>
                <StepIcon icon="👤" step="Step 1" title="Register & Login" />
                <StepIcon icon="🩺" step="Step 2" title="Find Your Doctor" />
                <StepIcon icon="🗓️" step="Step 3" title="Book a Time Slot" />
            </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <div className="p-6">
                        <h3 className="text-2xl font-semibold">Dr. R. Sharma</h3>
