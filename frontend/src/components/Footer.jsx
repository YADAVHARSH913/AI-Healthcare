  ...
  return (
    <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-8">
            ...
            <div className="col-span-2 md:col-span-4 lg:col-span-5">
              ...
              <p className="text-sm text-gray-400 max-w-xs">
                Revolutionizing healthcare with AI for a smarter, healthier future. Your trusted partner in wellness.
              </p>
            </div>

            {/* Links Sections */}
            <div className="col-span-1 md:col-span-2 lg:col-span-2">
              <h3 className="text-base font-semibold text-white tracking-wider uppercase mb-4">Product</h3>
            ...
            <div className="col-span-2 md:col-span-2 lg:col-span-3">
              <h3 className="text-base font-semibold text-white tracking-wider uppercase mb-4">Legal</h3>
              <ul className="space-y-3 text-sm">
      ...
      <div className="bg-black">
        <div className="container mx-auto px-6 py-4 flex flex-col sm:flex-row justify-between items-center text-gray-500 text-sm">
